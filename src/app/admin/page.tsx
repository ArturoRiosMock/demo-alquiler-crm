...
export default function ActivosPage() {
  ...
  const filtered = useMemo(() => {
    let res = assets.filter(a => {
      ...
      if (q) {
        const blob = [a.id, a.cat, a.prov, a.pob, a.addr, a.tip, a.fase, a.cp, a.adm.car, a.catRef, String(a.precio || ""), String(a.sqm || "")].join(" ").toLowerCase();
      ...
      <div className="p-5">
        ...
        <div className="mb-3 rounded-lg border border-border bg-white p-3.5 shadow-sm">
          <div className="flex flex-wrap items-end gap-2.5">
            ...
            <FilterSelect label="Tipología" value={fTipo} onChange={setFTipo} options={["Vivienda", "Parking", "Trastero", "Local"]} />
        ...
        <div className="overflow-hidden rounded-lg border border-border bg-white shadow-sm">
          <div className="grid grid-cols-[32px_28px_72px_100px_100px_1fr_56px_56px_100px_105px_95px_28px] items-center gap-1.5 bg-navy px-3.5 py-2.5">
            <div
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map(a => (
              <Link
                ...
                className="grid grid-cols-[32px_28px_72px_100px_100px_1fr_56px_56px_100px_105px_95px_28px] items-center gap-1.5 border-b border-border2 px-3.5 transition-colors last:border-b-0 hover:bg-cream/50"
                style={{ height: 46 }}
              >
                <div
                ...
                <span className={`inline-flex w-fit rounded-md px-2 py-0.5 text-[10px] font-semibold ${pillClass[a.faseC] || ""}`}>{a.fase}</span>
